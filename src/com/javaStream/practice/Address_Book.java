...
public class Address_Book {
	...
	public void sortByCity() {
		List<Contacts> sortedCityList = arrList.stream().sorted(Comparator.comparing(Contacts::getCity)).collect(Collectors.toList());
		System.out.println("Sorted city list is : " + sortedCityList);
	}
	
	public void sortByState() {
		List<Contacts> sortedStateList = arrList.stream().sorted(Comparator.comparing(Contacts::getState)).collect(Collectors.toList());
		System.out.println("Sorted state list is : " + sortedStateList);
	}
	
	public void sortByZip() {
		List<Contacts> sortedZipList = arrList.stream().sorted(Comparator.comparingLong(Contacts::getZip)).collect(Collectors.toList());
		System.out.println("Sorted zip list is : " + sortedZipList);
	}
